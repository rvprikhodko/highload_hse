...
|                       | Логирование старта        | Запись события просмотра     | Eventual consistency      |
...
| Запрос                         | Домен                |
| ------------------------------ | -------------------- |
| API (метаданные, рекомендации) | api.youtube.local    |
...
Берем размещение четырёх датацентров:
...
## Схема DNS-балансировки (GeoDNS)
               ...
               v          v       v            v
        +---------+ +---------+ +---------+ +---------+
        | DC USA  | | DC EU   | | DC ASIA | | DC SA   |
        | 284k RPS| |203k RPS | |244k RPS | | 81k RPS |
        +---------+ +---------+ +---------+ +---------+
...
## Схема Anycast-балансировки (CDN)
        ...
        +---------+ +---------+ +---------+ +---------+
        | DC USA  | | DC EU   | | DC ASIA | | DC SA   |
        |12.25 Tb | |8.75 Tb  | |10.5 Tb  | |3.5 Tb   |
        +---------+ +---------+ +---------+ +---------+
